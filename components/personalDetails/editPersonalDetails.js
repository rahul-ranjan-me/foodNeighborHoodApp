...
export default function EditPersonalDetails(props) {
  ...
  const updatePersonalDetails = () => {
    ...
    globalStorage
      ...
      .then((res) => {
        xhrPut(`/users/${res.username}`, toUpdate, {
          headers: {
  ...
  return (
    <View style={styles.personalDetailsWrapper}>
      <Text style={styles.personalDetailsHeading}>
      ...
      <View style={styles.inputWrapper}>
        ...
        <TextInput
          style={styles.input}
          onChangeText={(text) => (inputValues.name = text)}
          defaultValue={name}
        />
      </View>
      <View style={styles.inputWrapper}>
        ...
        <TextInput
          style={styles.input}
          onChangeText={(text) => (inputValues.phoneNumber = text)}
          defaultValue={phoneNumber ? String(phoneNumber) : ""}
        />
      </View>
      <View style={styles.inputWrapper}>
        ...
        <TextInput
          style={styles.input}
          onChangeText={(text) => (inputValues.email = text)}
          defaultValue={email}
        />
      </View>
      <View style={styles.inputWrapper}>
        ...
        <TextInput
          ...
          numberOfLines={4}
          style={styles.input}
          onChangeText={(text) => (inputValues.address = text)}
